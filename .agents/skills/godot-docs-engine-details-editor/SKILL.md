---
name: godot-docs-engine-details-editor
description: "Use when working with the local godot-docs Engine details module for Editor development: answer, inspect, or update Godot documentation for Editor development. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/engine_details/editor/index.rst."
---

# Godot Docs Editor development

## Source

- Area: Engine details
- Start file: `godot-docs/engine_details/editor/index.rst`
- Purpose: answer, inspect, or update Godot documentation for Editor development.
...
- `introduction_to_editor_development` - Introduction to editor development
- `creating_icons` - Editor icons
