---
name: godot-docs-about-complying-with-licenses
description: "Use when working with the local godot-docs About module for Complying with licenses: answer, inspect, or update Godot documentation for Complying with licenses. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/about/complying_with_licenses.rst."
---

# Godot Docs Complying with licenses

## Source

- Area: About
- Start file: `godot-docs/about/complying_with_licenses.rst`
- Purpose: answer, inspect, or update Godot documentation for Complying with licenses.
