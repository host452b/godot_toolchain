---
name: godot-docs-tutorials-scripting-cpp-build-system
description: "Use when working with the local godot-docs Manual module for Build system: work with the Build system documentation module and its child pages. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/scripting/cpp/build_system/index.rst."
---

# Godot Docs Build system

## Source

- Area: Manual
- Start file: `godot-docs/tutorials/scripting/cpp/build_system/index.rst`
- Purpose: work with the Build system documentation module and its child pages.
...
- `scons` - Main build system: Working with SCons
- `cmake` - Secondary build system: Working with CMake
