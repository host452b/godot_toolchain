---
name: godot-docs-tutorials-i18n
description: "Use when working with the local godot-docs Manual module for Internationalization: answer, inspect, or update Godot documentation for Internationalization. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/i18n/index.rst."
---

# Godot Docs Internationalization

## Source

- Area: Manual
- Start file: `godot-docs/tutorials/i18n/index.rst`
- Purpose: answer, inspect, or update Godot documentation for Internationalization.
...
- `internationalizing_games` - Internationalizing games
- `localization_using_spreadsheets` - Localization using spreadsheets
- `localization_using_gettext` - Localization using gettext (PO files)
