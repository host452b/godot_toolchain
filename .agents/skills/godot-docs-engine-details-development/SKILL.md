---
name: godot-docs-engine-details-development
description: "Use when working with the local godot-docs Engine details module for Engine development: answer, inspect, or update Godot documentation for Engine development. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/engine_details/development/index.rst."
---

# Godot Docs Engine development

## Source

- Area: Engine details
- Start file: `godot-docs/engine_details/development/index.rst`
- Purpose: answer, inspect, or update Godot documentation for Engine development.
...
- `configuring_an_ide/index` - Configuring an IDE
- `compiling/index` - Building from source
- `debugging/index` - Debugging
- `profiling/index` - Using C++ profilers
- `handling_compatibility_breakages` - Handling compatibility breakages
