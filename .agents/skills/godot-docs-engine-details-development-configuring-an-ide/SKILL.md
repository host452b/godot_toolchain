---
name: godot-docs-engine-details-development-configuring-an-ide
description: "Use when working with the local godot-docs Engine details module for Configuring an IDE: work with the Configuring an IDE documentation module and its child pages. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/engine_details/development/configuring_an_ide/index.rst."
---

# Godot Docs Configuring an IDE

## Source

- Area: Engine details
- Start file: `godot-docs/engine_details/development/configuring_an_ide/index.rst`
- Purpose: work with the Configuring an IDE documentation module and its child pages.
