---
name: godot-docs-tutorials-platform-linux
description: "Use when working with the local godot-docs Manual module for Linux: work with the Linux documentation module and its child pages. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/platform/linux/index.rst."
---
...
- Area: Manual
- Start file: `godot-docs/tutorials/platform/linux/index.rst`
- Purpose: work with the Linux documentation module and its child pages.
