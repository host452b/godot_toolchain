---
name: godot-docs-engine-details-class-reference
description: "Use when working with the local godot-docs Engine details module for Class reference primer: answer, inspect, or update Godot documentation for Class reference primer. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/engine_details/class_reference/index.rst."
---

# Godot Docs Class reference primer

## Source

- Area: Engine details
- Start file: `godot-docs/engine_details/class_reference/index.rst`
- Purpose: answer, inspect, or update Godot documentation for Class reference primer.
