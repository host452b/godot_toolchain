---
name: godot-docs-community-tutorials
description: "Use when working with the local godot-docs Community module for Tutorials and resources: answer, inspect, or update Godot documentation for Tutorials and resources. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/community/tutorials.rst."
---

# Godot Docs Tutorials and resources

## Source

- Area: Community
- Start file: `godot-docs/community/tutorials.rst`
- Purpose: answer, inspect, or update Godot documentation for Tutorials and resources.
