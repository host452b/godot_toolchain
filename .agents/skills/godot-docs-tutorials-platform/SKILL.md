---
name: godot-docs-tutorials-platform
description: "Use when working with the local godot-docs Manual module for Platform-specific: answer, inspect, or update Godot documentation for Platform-specific. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/platform/index.rst."
---

# Godot Docs Platform-specific

## Source

- Area: Manual
- Start file: `godot-docs/tutorials/platform/index.rst`
- Purpose: answer, inspect, or update Godot documentation for Platform-specific.
