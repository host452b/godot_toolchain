---
name: godot-docs-about-system-requirements
description: "Use when working with the local godot-docs About module for System requirements: answer, inspect, or update Godot documentation for System requirements. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/about/system_requirements.rst."
---

# Godot Docs System requirements

## Source

- Area: About
- Start file: `godot-docs/about/system_requirements.rst`
- Purpose: answer, inspect, or update Godot documentation for System requirements.
