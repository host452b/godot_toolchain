---
name: godot-docs-engine-details-file-formats
description: "Use when working with the local godot-docs Engine details module for Godot file formats: answer, inspect, or update Godot documentation for Godot file formats. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/engine_details/file_formats/index.rst."
---

# Godot Docs Godot file formats

## Source

- Area: Engine details
- Start file: `godot-docs/engine_details/file_formats/index.rst`
- Purpose: answer, inspect, or update Godot documentation for Godot file formats.
...
- `gdscript_grammar.rst` - GDScript grammar
- `tscn.rst` - TSCN file format
