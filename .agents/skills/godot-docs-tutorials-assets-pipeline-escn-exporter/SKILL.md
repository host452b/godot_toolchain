---
name: godot-docs-tutorials-assets-pipeline-escn-exporter
description: "Use when working with the local godot-docs Manual module for Blender ESCN exporter: work with the Blender ESCN exporter documentation module and its child pages. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/assets_pipeline/escn_exporter/index.rst."
---

# Godot Docs Blender ESCN exporter

## Source

- Area: Manual
- Start file: `godot-docs/tutorials/assets_pipeline/escn_exporter/index.rst`
- Purpose: work with the Blender ESCN exporter documentation module and its child pages.
