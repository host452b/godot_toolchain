---
name: godot-docs-about-release-policy
description: "Use when working with the local godot-docs About module for Godot release policy: answer, inspect, or update Godot documentation for Godot release policy. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/about/release_policy.rst."
---

# Godot Docs Godot release policy

## Source

- Area: About
- Start file: `godot-docs/about/release_policy.rst`
- Purpose: answer, inspect, or update Godot documentation for Godot release policy.
