---
name: godot-docs-about-list-of-features
description: "Use when working with the local godot-docs About module for List of features: answer, inspect, or update Godot documentation for List of features. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/about/list_of_features.rst."
---

# Godot Docs List of features

## Source

- Area: About
- Start file: `godot-docs/about/list_of_features.rst`
- Purpose: answer, inspect, or update Godot documentation for List of features.
