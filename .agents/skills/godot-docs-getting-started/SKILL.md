---
name: godot-docs-getting-started
description: "Use when working with the local godot-docs Getting started module for Getting started: route Getting started section questions across its local toctree entries. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/index.rst."
---
...
- Purpose: route Getting started section questions across its local toctree entries.
...
- Root sidebar caption: Getting started.
