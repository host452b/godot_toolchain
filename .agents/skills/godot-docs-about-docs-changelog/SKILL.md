---
name: godot-docs-about-docs-changelog
description: "Use when working with the local godot-docs About module for Documentation changelog: answer, inspect, or update Godot documentation for Documentation changelog. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/about/docs_changelog.rst."
---

# Godot Docs Documentation changelog

## Source

- Area: About
- Start file: `godot-docs/about/docs_changelog.rst`
- Purpose: answer, inspect, or update Godot documentation for Documentation changelog.
