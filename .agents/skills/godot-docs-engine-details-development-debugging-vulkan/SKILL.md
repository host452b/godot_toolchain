---
name: godot-docs-engine-details-development-debugging-vulkan
description: "Use when working with the local godot-docs Engine details module for Vulkan: work with the Vulkan documentation module and its child pages. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/engine_details/development/debugging/vulkan/index.rst."
---
...
- Area: Engine details
- Start file: `godot-docs/engine_details/development/debugging/vulkan/index.rst`
- Purpose: work with the Vulkan documentation module and its child pages.
...
- `vulkan_validation_layers` - Validation layers
