---
name: godot-docs-tutorials-platform-ios
description: "Use when working with the local godot-docs Manual module for iOS plugins: work with the iOS plugins documentation module and its child pages. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/platform/ios/index.rst."
---

# Godot Docs iOS plugins

## Source

- Area: Manual
- Start file: `godot-docs/tutorials/platform/ios/index.rst`
- Purpose: work with the iOS plugins documentation module and its child pages.
...
- `ios_plugin` - Creating iOS plugins
- `plugins_for_ios` - Plugins for iOS
