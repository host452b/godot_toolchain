---
name: godot-docs-tutorials-performance-vertex-animation
description: "Use when working with the local godot-docs Manual module for Animating thousands of objects: work with the Animating thousands of objects documentation module and its child pages. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/performance/vertex_animation/index.rst."
---

# Godot Docs Animating thousands of objects

## Source

- Area: Manual
- Start file: `godot-docs/tutorials/performance/vertex_animation/index.rst`
- Purpose: work with the Animating thousands of objects documentation module and its child pages.
...
- `animating_thousands_of_fish` - Animating thousands of fish with MultiMeshInstance3D
- `controlling_thousands_of_fish` - Controlling thousands of fish with Particles
