---
name: godot-docs-tutorials-plugins
description: "Use when working with the local godot-docs Manual module for Plugins: answer, inspect, or update Godot documentation for Plugins. Trigger on Godot docs, Sphinx toctree, reST, API reference, or source path godot-docs/tutorials/plugins/index.rst."
---
...
- Area: Manual
- Start file: `godot-docs/tutorials/plugins/index.rst`
- Purpose: answer, inspect, or update Godot documentation for Plugins.
...
- `editor/index` - Editor plugins
- `running_code_in_the_editor` - Running code in the editor
